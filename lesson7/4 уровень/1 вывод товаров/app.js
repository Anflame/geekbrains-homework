...
console.log(products.phones[0]);
let button = document.querySelectorAll('button');
let classProduct = document.querySelector('.products');
...
function clickHandler(event) {
    if (classProduct.innerHTML != "") {
        classProduct.innerHTML = "";
    }
...
function showCategory(category) {
    products[category].forEach(product => {
        classProduct.insertAdjacentHTML('beforeend', getProductMarkup(product));
    });
}
